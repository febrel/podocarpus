...

{
	...
	$foto_db = mysqli_fetch_array($miconexion->consulta("SELECT galeria FROM lugares WHERE id_servicios ='" . $no . "' "));
	...
	$miconexion->consulta("DELETE FROM lugares WHERE idLugares='" . $no . "' ");
