...
$miconexion->consulta("SELECT * FROM staff WHERE id='".$no."' ");
...
<body>
  ...
  <div class="main-container">
      ...
      <input  type="hidden" id="id" name="id" placeholder="Id Lugar"><br>

		<label>Nombre Servicio</label>
  		<input class="text" type="text" id="name" name="name" placeholder="Nombre " value="<?php echo $lista[1];?>"><br>

		<label>Longitud</label>
  		<input class="text" type="text" id="lastname" name="lastname" placeholder="Apellido" value="<?php echo $lista[2];?>"><br>
